...
const OrderCard: React.FC<{ order: OrderCardProps['order'] }> = ({ order }) => {
  return (
    <View style={styles.card}>
      <Text appearance="hint" style={styles.dateText}>{order.date}</Text>
      ...
      <View style={styles.contentRow}>
        ...
        <View style={styles.infoColumn}>
          <View style={styles.titleRow}>
            <Text category="s1" style={styles.productName}>{order.productName}</Text>
            <Text status="primary" style={styles.price}>{order.price}</Text>
          </View>
